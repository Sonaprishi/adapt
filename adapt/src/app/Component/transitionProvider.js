...
const TransitionProvider =({children}) => {
    ...
    return(
        <AnimatePresence mode="wait">
            <div key={pathName} className=" h-screen w-screen bg-gradient-to-b from-blue-50 to-red-100 text-black">
                ...
                >
                 ...
                 <motion.div className=" h-screen w-screen fixed bg-black-500 rounded-t-[100px] bottom-0 z-40" 
